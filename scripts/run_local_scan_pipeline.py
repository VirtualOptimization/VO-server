"""Run a local RoomPlan optimization pipeline and write debug artifacts.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--local-only",
        action="store_true",
        help="Skip differential evolution and run only the local optimizer from scanned poses.",
    )
    parser.add_argument(
        "--skip-s3-upload",
        action="store_true",
