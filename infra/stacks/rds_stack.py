...
class VoRdsStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        selected_subnet_type = (
            ec2.SubnetType.PUBLIC if publicly_accessible else ec2.SubnetType.PRIVATE_WITH_EGRESS
        )
        ...
        CfnOutput(self, "RdsPort", value=instance.instance_endpoint.port.to_string())
