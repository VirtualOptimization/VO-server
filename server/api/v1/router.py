...
from server.api.v1.endpoints import assistant, auth, furniture, scan, rooms, rooms_edit
...
router.include_router(assistant.router, prefix="/assistant", tags=["AI 배치 상담"])
